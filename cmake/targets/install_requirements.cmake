...
if     (VERSION_OF_MDBOOK_ADMONISH STREQUAL "[none]")
    set(CRATE_OF_MDBOOK_ADMONISH "")
elseif (VERSION_OF_MDBOOK_ADMONISH STREQUAL "")
    set(CRATE_OF_MDBOOK_ADMONISH "mdbook-admonish")
else()
    set(CRATE_OF_MDBOOK_ADMONISH "mdbook-admonish@${VERSION_OF_MDBOOK_ADMONISH}")
endif()
remove_cmake_message_indent()
message("")
message("VERSION_OF_MDBOOK              = ${VERSION_OF_MDBOOK}")
message("VERSION_OF_MDBOOK_I18N_HELPERS = ${VERSION_OF_MDBOOK_I18N_HELPERS}")
message("VERSION_OF_MDBOOK_ADMONISH     = ${VERSION_OF_MDBOOK_ADMONISH}")
message("CRATE_OF_MDBOOK                = ${CRATE_OF_MDBOOK}")
message("CRATE_OF_MDBOOK_I18N_HELPERS   = ${CRATE_OF_MDBOOK_I18N_HELPERS}")
message("CRATE_OF_MDBOOK_ADMONISH       = ${CRATE_OF_MDBOOK_ADMONISH}")
message("")
execute_process(
